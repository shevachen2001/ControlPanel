...
#define E_DUPLICATE_KEY 0x0A
#define E_MAX_KEY_COUNT 0x0B
#define E_MAX_BLACKLIST_COUNT 0x0E
#define E_END_LIGHT  0x7E  /* 只需要灯光提示*/
#define E_END  0x7F
#define E_GET_ACK 0x80
#define E_INVALID_KEY_TYPE 0x17
#define E_KEY_NOT_SET 0x18
#define E_KEY_NOT_FOUND 0x19
#define E_KEY_NOT_DELETED 0x20
#define E_INVALID_RESET_CONFIG 0x22
#define E_RTC_READ_ERR 0x23
#define E_RTC_WRITE_ERR 0x24
#define E_INVALID_KEY_VALUE 0x25
#define E_INVALID_TIME_RANGE 0x26
#define E_INVALID_MODE 0x27
...
#define BUILD_ACTIONTYPE(type, action) \
          ((uint8)(((action) & 0x01)|(((type) & 0x7F) << 1)))

#define BUILD_TYPE(x)      (x>>1)
#define BUILD_ACTION(x)  (x&0x01)
