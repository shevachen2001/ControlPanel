...
#define WATCHDOG_EN            STD_TRUE//STD_TRUE
...
#define RC523_TYPEB                STD_FALSE //STD_FALSE  /* TRUE:身份证*/
#define RC522_RDDAT                STD_FALSE
...
#define USE_FLASH_NRF           STD_FALSE//STD_TRUE                    //用单片机内部FLASH
